...
public class Backgrounds{	
	...
	public Backgrounds(Level new_active_world){
		...
		background_clouds_parallax_ratio = (BACKGROUND_CLOUDS_WIDTH - BaseRenderer.BASE_RENDERER_FRUSTUM_WIDTH) / 
			(Level.WORLD_WIDTH - BaseRenderer.BASE_RENDERER_FRUSTUM_WIDTH);
		background_back_layer_parallax_ratio = (BACKGROUND_CAVE_BACK_LAYER_WIDTH - BaseRenderer.BASE_RENDERER_FRUSTUM_WIDTH) / 
			(Level.WORLD_WIDTH - BaseRenderer.BASE_RENDERER_FRUSTUM_WIDTH);
		background_middle_layer_parallax_ratio = (BACKGROUND_CAVE_MIDDLE_LAYER_WIDTH - BaseRenderer.BASE_RENDERER_FRUSTUM_WIDTH) / 
			(Level.WORLD_WIDTH - BaseRenderer.BASE_RENDERER_FRUSTUM_WIDTH);
	...
	public static void update() {
		...
		new_position.y = BaseRenderer.BASE_RENDERER_FRUSTUM_HEIGHT - active_world.position.y;
