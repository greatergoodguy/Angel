...
public class TreetopValleyFactory {
	...
	*/
	...
	private void createPurpleGhostStandardPatternLeft(float x_coord, float y_coord, float state_timer_offset){
		PurpleGhost purple_ghost = pool_manager.purple_ghost_pool.newObject();
		purple_ghost.reset(x_coord, y_coord);
		purple_ghost.changeToStandardStateLeft(state_timer_offset);
		purple_ghosts.add(purple_ghost);
	...
	public void initializePart1() {
		createPurpleGhostWalkPatternRight(5.5f, 4.2f);
	...
	public void initializePart2() {
		...
		createFloatRedWhaleDemon(29.2f, 1.2f);
	}
	
	public void initializePart3() {
		createPurpleGhostStandardPatternLeft(30.5f, 5.1f, 1.2f);
		createOscillateHorizontalCloudPlatform(33, 0.2f);
		
		createPurpleGhostStandardPatternLeft(38.0f, 2.0f);
		createStaticCloudPlatformShort(32.8f, 2.4f);
		createStaticCloudPlatformShort(36.3f, 3.7f);
		createStaticCloudPlatformShort(30.5f, 4.4f);
		createStaticCloudPlatformShort(37.3f, 1.2f);
		
		createStaticCloudPlatformShort(38.7f, 5.8f);
		createStaticCloudPlatformShort(32.7f, 5.8f);
		createStaticCloudPlatformShort(36.2f, 7.9f);
		createStaticCloudPlatformShort(39f, 9.6f);
		createStaticCloudPlatformShort(34.5f, 11f);
		
		createPurpleGhostWalkPatternRight(32.2f, 12f);
		createStaticCloudPlatformShort(32.5f, 11.7f);
		createStaticCloudPlatformShort(33.3f, 13.8f);
		createStaticCloudPlatformShort(35.0f, 15.2f);
		
		createStaticCloudPlatform(38, 16.8f);
	}

	public void activateLevelTwo() {
		createStaticCloudPlatform(30, 15.6f);
		createStaticCloudPlatform(33, 15.6f);
		createStaticCloudPlatform(36, 15.6f);
		createStaticCloudPlatform(39, 15.6f);
		
	}

	public void initializePart4() {
		createStaticCloudPlatform(17, 15.0f);
		createStaticCloudPlatform(20, 15.0f);
		createStaticCloudPlatform(23, 15.0f);

		createStaticCloudPlatformShort(22.0f, 17f);
		createTackleRedWhaleDemonRight(18, 15.8f);
